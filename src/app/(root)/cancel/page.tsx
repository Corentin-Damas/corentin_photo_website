  ...
  return (
    <>
      ...
      <div className={styles.informations_container}>
        ...
        <p>
          You have cancel the paying request, you can still access your{" "}
          <Link href={"/shop"} className={styles.informations__links}>
            cart
          </Link>{" "}
          and the{" "}
          <Link href={"/shop"} className={styles.informations__links}>
          ...
          . <br /> For more information you can contact me on the{" "}
