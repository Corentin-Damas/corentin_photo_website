/*
  ...
  - You are about to drop the column `frame` on the `fram` table. All the data in the column will be lost.
  - You are about to drop the column `glass` on the `fram` table. All the data in the column will be lost.
  - You are about to drop the column `paper` on the `fram` table. All the data in the column will be lost.
